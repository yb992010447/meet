...
exports.default = exports.flagWidth = void 0;

var _styledComponents = _interopRequireWildcard(require("styled-components"));

var _theme = require("@atlaskit/theme");

var flagWidth = (0, _theme.gridSize)() * 50; // This is the translateX position that we target when animating a card out
...
var animationEnter = (0, _styledComponents.keyframes)(["\n    from {\n      opacity: 0;\n      transform: translate(", ", 0);\n    }\n    to {\n      opacity: 1;\n      transform: translate(0, 0);\n    }\n"], exitXPosition);
var animationLeave = (0, _styledComponents.keyframes)(["\n  from {\n    opacity: 1;\n    transform: translate(0, 0);\n  }\n  to {\n    opacity: 0;\n    transform: translate(", ", 0);\n  }\n"], exitXPosition);
