...
function (_Component) {
  ...
  function FlagActions() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getButtonFocusRingColor", function () {
      return 'focusRingColor';
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getButtonTheme", function () {
      return 'buttonTheme';
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getButtonAppearance", function (b) {
      return b ? 'default' : 'subtle-link';
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getButtonSpacing", function (b) {
      return b ? 'compact' : 'none';
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getUniqueId", function (prefix) {
