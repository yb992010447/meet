...
function (_Component) {
  ...
  function AutoDismissFlag() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "autoDismissTimer", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "startAutoDismissTimer", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "stopAutoDismissTimer", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "dismissFlag", function () {
      if (_this.isAutoDismissAllowed() && _this.props.onDismissed) {
        _this.props.onDismissed(_this.props.id);
      }
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleAutoDismissTimerEnd", function () {
      _this.dismissFlag();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleInteractionStart", function () {
      _this.stopAutoDismissTimer();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "isAutoDismissAllowed", function () {
      return _this.props.isDismissAllowed && _this.props.onDismissed;
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleInteractionEnd", function () {
